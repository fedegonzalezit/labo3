...
fe_pipeline = Pipeline(
    steps=[
        ...
        FeatureEngineeringLagStep(lags=[1,2,3,11], columns=["tn", "cust_request_qty"]),
        RollingMeanFeatureStep(windows=[6], columns=["tn", "cust_request_qty"], n_jobs=1),
        #RollingMedianFeatureStep(windows=list(range(2,15)), columns=["tn"]),
        RollingStdFeatureStep(windows=[6], columns=["tn", "cust_request_qty"], n_jobs=1),
        RollingMaxFeatureStep(windows=[6], columns=["tn", "cust_request_qty"], n_jobs=1),
        RollingMinFeatureStep(windows=[6], columns=["tn", "cust_request_qty"], n_jobs=1),
